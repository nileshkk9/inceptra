$(document).ready(function() {
  ...
  $(window).scroll(function() {
    ...
    if (scroll > position && scroll > 310) {
      if (
        $("body").hasClass("lightbox-enabled") ||
        $(".menu-nav").hasClass("menu-nav-active")
      ) {
  ...
  function count_down($area) {
    ...
    let countDown = new Date("April 5, 2020 11:00:00").getTime(),
  ...
  $(".portfilio-3__item__nor , .portfilio-3__item__2w").css(
    "height",
    port3_h + "px"
  );
  ...
  $(".portfilio-1__item__nor , .portfilio-1__item__2w").css(
    "height",
    port1hnor + "px"
  );
  ...
  $(".portfolio-2__item").on("mouseover", function() {
    $(this)
      .siblings()
      .addClass("portfolio-2__img-fade");
  });
...
$(window).on("load", function() {
  ...
  var content = $(".portfolio-3__grid"),
    tabs = $(".portfolio-3__categoties li");
  tabs.each(function() {
  ...
  tabs.on("click", function() {
    tabs
      .removeClass("port3-filter")
      .filter(this)
      .addClass("port3-filter");
    var filter = $(this).data("filter");
    content.isotope({
      filter: filter,
      layoutMode: "packery",
